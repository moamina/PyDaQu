...
if __name__ == '__main__':
	...
	# Data Source Code
    dataSource=DataSource("root","root","127.0.0.1","3306","bsadb",DataBaseType.MySQL)
...
#---------------------------------        
	...
	#Expectations For Column [updatedate]    	
    expectation_configuration = ExpectationUtil.expect_column_values_to_not_be_null("updatedate")
