...
public class DAT2GEUI2_copy1 extends JFrame {
	...
	private static DAT2GEUI2_copy1 mainUI;
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DAT2GEUI2_copy1 frame = new DAT2GEUI2_copy1();
	...
	public static DAT2GEUI2_copy1 getInstance() {
		if (mainUI == null) {
			mainUI = new DAT2GEUI2_copy1();
		}
		return mainUI;
	}
	...
	private DAT2GEUI2_copy1() {
		...
		btnOpen.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int returnVal = fc.showOpenDialog(DAT2GEUI2_copy1.this);
		...
		scrollPane.setBounds(16, 47, 180, 202);
		...
		btn_LoadCol.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					ArrayList<String> cols= (ArrayList<String>) new MetaData().getColumnList(selectedDQObj.getDbConnection(), selectedCol);
					DefaultListModel dlm = new DefaultListModel();
					for (String col : cols) {
						dlm.addElement(col.toString());
					}
		...
		scrollPane_3.setBounds(16, 46, 180, 201);
		...
		panel_5.setBounds(815, 75, 222, 438);
		contentPane.add(panel_5);
		panel_5.setLayout(null);
		
		JButton btn_LoadCol_2 = new JButton("Load Expectations");
		btn_LoadCol_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		btn_LoadCol_2.setBorder(new LineBorder(new Color(0, 0, 0)));
		btn_LoadCol_2.setForeground(new Color(0, 0, 0));
		btn_LoadCol_2.setBackground(new Color(192, 192, 192));
		btn_LoadCol_2.setIcon(null);
		btn_LoadCol_2.setBounds(10, 139, 202, 24);
		panel_5.add(btn_LoadCol_2);
		
		JScrollPane scrollPane_4 = new JScrollPane();
		scrollPane_4.setBounds(10, 11, 202, 117);
